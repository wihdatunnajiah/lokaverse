"""
Django settings for lokaverse project.
...
SECRET_KEY = 'django-insecure-2t8w3&k)eqer2xgoj*0$mb59rogf=4)akr18+hzb1i11$@t%!2'
...
WSGI_APPLICATION = 'lokaverse.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_lokaverse',       # Nama database MySQL yang telah Anda buat
        'USER': 'root',   # Username MySQL Anda
        'PASSWORD': 'lokaverse123',   # Password MySQL Anda
